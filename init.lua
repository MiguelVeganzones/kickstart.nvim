    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Jump to the implementation of the word under your curgor.
...
>>>>>>> fork_origin
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'cpp', 'diff', 'c_sharp', 'lua', 'markdown', 'markdown_inline', 'python', 'vim', 'vimdoc' },
